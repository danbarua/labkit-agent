...
export const context = (): TurnData => ({ id: ActorIdSchema.parse("turn/1"), generation: 0,
  agent: AgentIdSchema.parse("writer"), steps: StepsSchema.parse(6), messages: [], view: { kind: "history" } });
